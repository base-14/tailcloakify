            ...
            <form id="kc-register-form" action={url.loginAction} method="post">
                ...
                <button
                    ...
                    className={clsx(
                        ...
                        "items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus:ring-secondary focus:ring-offset-2 bg-secondary text-secondary-foreground hover:bg-secondary/90 disabled:pointer-events-none disabled:opacity-50 px-4 py-2 flex w-1/2"
                    )}
                    name="submitAction"
                    id="confirmOverride"
